        ...
        - Scope
            ...
            - 자바스크립트 유효범위의 특징
                ...
                - 변수명 중복 허용
                    ...
                    - 단, 같은 변수명이 여러개 있는 변수를 참조할 때 가장 가까운 범위의 변수를 참조한다.
                    - ex>
                        function scopeExam() {
                            scope = 20;
                ...
                - var 키워드의 생략
                    - 다른 프로그래밍 언어의 경우 변수를 선언할 때 변수형을 쓰지 않을 경우 에러가 난다. ( 하지만 javascript는 아니다! )
                    - 단, var 키워드를 빼먹고 변수를 선언할 경우, 전역 변수로 선언된다.
                - 렉시컬 특성
                    - ex>
                        var x = 1;
    ...
    [Hoisting]
        ...
        - 그러나..
            ex>
                ...
                - 오류가 나지 않는다.
                - 그 이유는 바로 호이스팅 때문이며, 선언 부분만 끌어올려졌기 때문이다.
                ...
                - 쉽게 생각하면 변수를 스코프 내 최상위로 끌어올린다고 생각하면 된다.
        - 영향 여부
            - 함수의 호이스팅도 변수의 호이스팅과 같은 맥락이지만 변수의 호이스